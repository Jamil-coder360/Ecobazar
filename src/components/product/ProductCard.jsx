...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className=" relative group bg-white border border-gray-100 hover:border-success_207 hover:shadow-success_207 rounded-md hover:shadow-sm transition-all duration-300 w-[264px] overflow-hidden ">
      {/* Sale Badge */}
      {sale && (
